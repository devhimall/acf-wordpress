                ...
                <div class="row portfolio-container">
                    <div class="col-lg-4 col-md-6 portfolio-item web-des">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio-1.jpg" class="img-fluid" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item web-des">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio-2.jpg" class="img-fluid" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item web-dev">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio-3.jpg" class="img-fluid" alt="">
                                <a href="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio-3.jpg" class="link-preview" data-lightbox="portfolio" data-title="Aliquam id sapien lorem" title="Preview"><i class="fa fa-eye"></i></a>
                                <a href="#" class="link-details" title="More Details"><i class="fa fa-link"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item web-dev">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio-4.jpg" class="img-fluid" alt="">
                                <a href="/<?php echo get_template_directory_uri(); ?>/assetsimg/portfolio-4.jpg" class="link-preview" data-lightbox="portfolio" data-title="Quisque lectus mauris" title="Preview"><i class="fa fa-eye"></i></a>
                                <a href="#" class="link-details" title="More Details"><i class="fa fa-link"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item app-dev">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio-5.jpg" class="img-fluid" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item app-dev">
                        <div class="portfolio-wrap">
                            <figure>
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/portfolio-6.jpg" class="img-fluid" alt="">
