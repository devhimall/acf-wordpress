	...
	if (function_exists('acf_register_block_type')) {
		...
		acf_register_block_type(array(
			...
			'enqueue_assets'    => function () {
				...
				wp_enqueue_style('block-slider', get_template_directory_uri() . '/assets/css/slider/slider.css', array(), '1.0.0');
				wp_enqueue_script('block-slider', get_template_directory_uri() . '/parts/blocks/slider/slider.js', array(), '1.0.0', true);
			},
		));
	}
}
